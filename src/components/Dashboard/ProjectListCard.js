                                            ...
                                            projectData.map((data,i)=>{
                                               return  <tr key={i} role="row" className="odd">
                                                                ...
                                                                <td className="project-actions">
                                                                    <a href="" className="btn btn-sm btn-outline-primary mr-1"><i className="icon-eye"></i></a>
                                                                    <a href="" className="btn btn-sm btn-outline-success mr-1"><i className="icon-pencil"></i></a>
                                                                    <a href="" className="btn btn-sm btn-outline-danger js-sweetalert" title="Delete" data-type="confirm"><i className="icon-trash"></i></a>
                                                                </td>
                                                        </tr>
                                            })
                                        }
