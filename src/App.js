...
import EnggDashboard from "./pages/EnggDashboard";
import EnggJobDetail from "./pages/EnggJobDetail";
import PmDashboard from "./pages/PmDashboard";
import PmJobDetail from "./pages/PmJobDetail";
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route exact path="/business-development" element={ <BDDashboard />} />
        <Route exact path="/job-detail" element={ <JobDetail />} />
        <Route exact path="/engineering-dashboard" element={ <EnggDashboard />} />
        <Route exact path="/engineering-job-detail" element={ <EnggJobDetail />} />
        <Route exact path="/project-management" element={ <PmDashboard />} />
        <Route exact path="/project-management-job-detail" element={ <PmJobDetail />} />
        <Route exact path="/qa-qc-dashboard" element={ <QcDashboard />} />
        <Route exact path="/qa-qc-job-detail" element={ <QcJobDetail />} />
